 ...
 ** It uses the JDBC-ODBC driver (and can be used with any DBMS through ODBC).
 **
 ** This program was written by nikos dimitrakas on Friday 2007-08-31
 ...
 **
 ** Last modified by nikos on 2015-10-13
 */

import java.sql.*;

public class DBJDBCODBC
{
    // DB connection variable
    static protected Connection con;
    // DB access variables
    private String URL = "jdbc:odbc:labb";
    ...
    public void connect()
    {
        try
        {
            ...
            con.setAutoCommit(false);
				//Some logging
				System.out.println("Connected to " + URL + " (using ODBC)");
        }
        catch (Exception e)
        {
            e.printStackTrace();
